...
struct Genre_Community: View {
    ...
    var body: some View {
                ...
                ZStack{
                    ...
                    VStack{
                        HStack{
                            ...
                            Image(systemName: "star.fill").resizable().scaledToFit().foregroundColor(.yellow).frame(width: 10, height: 10).cornerRadius(30).padding(.leading, -5)
                            Image(systemName: "star.fill").resizable().scaledToFit().foregroundColor(.yellow).frame(width: 10, height: 10).cornerRadius(30).padding(.leading, -5)
                            Image(systemName: "star.leadinghalf.filled").resizable().scaledToFit().foregroundColor(.yellow).frame(width: 10, height: 10).cornerRadius(30).padding(.leading, -5)
        ...
        }.searchable(text: $searchText).navigationBarTitle("Based On Genres")
    }
    var comList: [String]{
...
struct Genre_Community_Previews: PreviewProvider {
